...
namespace Nikon
{
    ...
    {
        // REF: https://sourceforge.net/p/nikoncswrapper/wiki/Model%20Information/ has the entire list

        public const string D500 = "Type0020.md3";
        public const string D7200 = "Type0017.md3";

        public const string Z7II = "Type0029.md3";
        public const string Z7 = "Type0023.md3";
    }

    public static class Cameras
    {
        public const string D500 = "d500";
        public const string D7200 = "d7200";

        public const string Z7II = "z7ii";
            ...
            foreach (var dataId in dataIds)
            {
                ...
                switch (dataObjectType)
                {
                    ...
                    case eNkMAIDDataObjType.kNkMAIDDataObjType_File | eNkMAIDDataObjType.kNkMAIDDataObjType_Sound:
                        if ((_previewReady != null) || (_lowResolutionPreviewReady != null) || (_thumbnailReady != null) || (_imageReady != null))
                        {
                            DataItemAcquire(data);
                        }
                        break;
